...
2. You must keep your `CLIENT_ID` and `CLIENT_SECRET` hidden with `.env` variables, specific to your plaform.
...
3. A button will appear "Checkuot with Feelpay" where the user can complete the transaction with FeelPay"
